...
<body>
    ...
    <div class="super_container">
        ...
        // Obtener el ID del producto desde el GET
        $idProd = isset($_GET['idProd']) ? $_GET['idProd'] : null;
        if (!$idProd) {
            // Manejo de error si no se proporciona un ID de producto válido
            echo '<h3>Producto no encontrado.</h3>';
            exit;
        }

        // Obtener detalles del producto seleccionado
        $dataProduct = detalles_producto_seleccionado($con, $idProd);
        if ($dataProduct === null) {
            echo '<h3>Producto no encontrado.</h3>';
            exit;
        }
                ...
                <div class="col-lg-5">
                    <div class="product_details">
                        ...
                        <div class="product_price">
                            Precio: $<?php echo number_format($dataProduct['precio'], 0, '', '.'); ?>
                        </div>
