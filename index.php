                    ...
                    while ($dataProduct = mysqli_fetch_array($resultadoProductos)) { ?>
                        <div class="col-6 col-md-3 mt-5 text-center Products">
                            <div class="card" style="max-height: 400px !important; min-height: 400px !important;">
                                <div>
                                    <img class="card-img-top" src="<?php echo htmlspecialchars($dataProduct["foto1"]); ?>" alt="<?php echo htmlspecialchars($dataProduct['nameProd']); ?>" style="max-width: 200px;">
                                </div>
                                <div class=" card-body text-center">
                                    <h5 class="card-title card_title"><?php echo htmlspecialchars($dataProduct['nameProd']); ?></h5>
                                    <?php
                                ...
                                <a href="detallesArticulo.php?idProd=<?php echo htmlspecialchars($dataProduct["prodId"]); ?>" class="red_button btn_puntos" title="Ver <?php echo htmlspecialchars($dataProduct['nameProd']); ?>">
                                    Ver Producto
